...
import (
	...
	"github.com/yowcow/golang-intro/hello"
)
...
func TestAppendStr(t *testing.T) {
	str := hello.AppendStr("Hello ", "world")
	if str != "Hello world" {
