...
func TestGetFileContent(t *testing.T) {
	...
	b, e := GetFileContent("../_data/hoge.txt")
...
func TestDecodeYAML(t *testing.T) {
	...
	b, err := GetFileContent("../_data/hoge.txt")
...
func TestFileCopy(t *testing.T) {
	...
	actual, _ := ioutil.ReadFile(filepath.Join(dir, "test.data"))
	expected, _ := ioutil.ReadFile("../_data/hoge.txt")
